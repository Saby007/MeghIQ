...
async def generate_report(
    ...
    try:
        ...
        if not output_path:
            ...
            # Prevent path traversal — must end in .pdf and stay under
            # the working directory or system temp.
            output_path = validate_output_path(output_path, allowed_extensions=[".pdf"])
